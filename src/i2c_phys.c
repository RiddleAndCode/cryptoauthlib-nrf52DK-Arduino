 ...
 * */
// __attribute__((weak)) void i2c_send_start(void) {
//   // Do nothing
// }
...
//  * \return status of the operation
//  * */
// __attribute__((weak)) void i2c_send_stop(void) {
...
//  * \return status of the operation
//  */
// __attribute__((weak)) ATCA_STATUS i2c_send_bytes(uint8_t  count, const uint8_t * data) {
//   (void)(count);
//   (void)(data);
//   extern int fd;
...
//  * \return status of the operation
//  */
// __attribute__((weak)) void i2c_receive_byte(uint8_t *data) {
...
//  * \return status of the operation
//  */
// __attribute__((weak)) void i2c_receive_bytes(uint8_t  count,  uint8_t * data) {
//   (void)(count);
//   (void)(data);
...
uint8_t i2c_send_slave_address(uint8_t read) {
  // Do nothing
  i2c_send_start();
  uint8_t buf = (AES132_I2C_DEFAULT_ADDRESS)|read;
	unsigned char ack = 0;
